...
| ⬜ | **Fassaden-Öffnungen ohne Bogen/Text** (Terrassentür nur mit Rahmen + Maß): Angerer-Südseite seziert — Becken fließt 0,7 m über die Fassadenlinie, Wohnraum-Umfassung 57 %. Text-Extraktion verwirft „FPH 2,75/STUK +2,20" (h = −0,55 < 0); Rahmen sind unpochierte Mini-Rects. Braucht eigenen gemessenen Ansatz (Rahmen-Linien als Grenze oder Extraktions-Fallback) — Blind-Verschluss würde Carports/Loggien zumauern |
| ⬜ | **Velden schraffurlose Wände** (16/25, gemischte ±30-50 %-F-Fehler): Wand-Paar-Rückfall trägt (0→16); ✅ Treppen-Serien-Filter (Stufen ≠ Wände, Bucket-Kette) — Rest sind 9 Räume mit Rückfall-Qualitätsfehlern im fragmentierten Zeichenstil — eigene Iteration nötig, NICHT mit der Tür-Guard-Logik verwechseln |
