...
async def projekt_massen(body: ProjektMassenRequest):
    ...
    if starker_textlayer:
        for r in merged_rooms:
            ...
            # Vision-Raum (nicht text-first) OHNE lesbaren Bodenbelag in einem stark
...
_NZ_CACHE_V = 53  # Stempel-Gate für Umrisse + konstruierter Ersatz-Umriss (115/115 markiert) + rechtwinklig gezogene Umrisse
...
def _vision_raum_regionen(plan_id, r, seite, page=None):
    ...
    try:
        ...
        if n:
            ...
            # Textfleck liegt im Median 0,04 m vom echten Stempel — Vision
            # kommt auf 0,39 m und streut. Also: Vision sagt WELCHER Raum wo
