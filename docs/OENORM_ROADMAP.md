...
*Erledigt seit Erstellung: Korrektur-Seiten-Key-Bugfix ✓ · Kalibrierung-Navbar-Links ✓ (Commit 1f31ae0) · #9 Workflow-Stepper aktiviert ✓ (b9608f9 + 5dc46d4, live verifiziert: Übersicht-Default unverändert, Schritt 2 = Prüfliste-Kartenraster + Planansicht mit Overlay, Übersicht stellt alles wieder her — Seitenhöhe 2553→5041px gemessen; Export-Konsolidierung auf 1 Primär-Button + .xlsx noch offen) · Fenster-Marker am Plan ✓ (e4a722e: Vision-Fenster mit pos_pt → Overlay+Aufmaßblatt, Sadiku 18/18 im Bild, visuell geprüft) · #15 Stufe 1 Scan-Geometrie ✓ (2510-Scan: 0/23 → 20/20 Raum-Umfänge aus Raum-Proportion U≈2(√(F·r)+√(F/r)), Vision-Bbox + Fuzzy-Name + Default 1,35 ohne Gänge; alle isoperimetrisch plausibel; ÖNORM-Zeilen live „U≈ (geschätzt)" vs. „U=" byte-exakt, Raum-Aufmaß ≈-Flag; echte Scan-Wandgeometrie/OCR bleibt Stufe 2) · Scan-Dubletten-Merge ✓ + Hüllen-Anker ✓ (rev .14: identische-F-Präfix-Merge gegen doppelte Wandflächen, 5 Logik-Tests; Bodenplatte/Decke/WDVS/Gerüst 📍-klickbar → Hülle pulst, Showcase 4+62 Anker regressionsfrei) · #8 Füllflächen-Wände ✓ (rev .15: Holzbau-Hülle 6,95→36,2 m via Fill-Rect-Gesamtspannen + Verdrängung der Ständer-Fehllesungen; Gate = kein Legende-Snap → Mauerwerks-Korpus byte-identisch 27/36/16/214; H1/H2 falsifiziert dokumentiert) · Symbol-Median ✓ (rev .17: 3 parallele Zählungen, Median kappt Fenster-Liste; sequenziell kippte übers Vercel-Limit — parallel 200 OK 222-260s; Streuung 20↔16 → 18↔16) · #9-Rest Export-Konsolidierung ✓ (rev .18: /api/aufmass-xlsx WYSIWYG-Export mit openpyxl — Übersicht + Blatt je Gewerk mit Herleitung (U≈ geschätzt auch im Excel) + Materialliste + Raum-Aufmaß; UI: 2 Primär-Buttons (Akzent wandert mit Preset: Rohbau→Materialliste, Ausbau/Kalkulant→.xlsx) + Weitere-Formate-Dropdown; live 12 Blätter am Showcase verifiziert; A-2063-XML bleibt offen) · #1-Rest Leibungs-lfm ✓ (rev .19: B 2204 ≤0,25 m Tiefe → lfm der Abwicklung 2H+B, darüber m²; Putz/Maler/WDVS je 1.1a lfm + 1.1b m²; live Putz 6,2 lfm/Maler 11,94 lfm; Polier 13/13 + 120 Fuzz + test_alles grün) · Fenster-Listen-Konsens ✓ (rev .20: 3 parallele Crop-Lesungen, Median-Instanzen 2/3-Regel — gemessen 14↔16 statt 20↔16, Kern stabil) · Erdarbeiten LG 02 ✓ (rev .21: B 2205 Annahme-Positionen Humus/Aushub mit KG-Weiche/Rollierung/Hinterfüllung, Basis plan-belegt, Tiefen je Firma überschreibbar, Hüllen-Anker; live 4 Positionen am Showcase; 6 Guards) · W02-Wohnungsfilter ✓ (f77138a: MFH-Minderheits-Guard, test_generalisierung grün)*